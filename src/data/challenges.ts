...
export const mockChallenges: Challenge[] = [
  ...
  {
    id: '8',
    title: 'Многослойная защита: Caesar, AES, Stego',
    description: 'Ваша команда обнаружила подозрительный архив на сервере конкурента. Согласно разведданным, в архиве содержится важная информация, скрытая за несколькими слоями шифрования и стеганографии.',
    category: 'crypto',
    difficulty: 'advanced',
    points: 350,
    tags: ['cryptography', 'steganography', 'multi-layer-encryption'],
    solved: false,
    solvedBy: 28,
