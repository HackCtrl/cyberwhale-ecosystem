...
export const mockChallenges: Challenge[] = [
  ...
  },
  {
    ...
    description: 'Ваша команда обнаружила подозрительный архив на сервере конкурента. Согласно разведданным, в архиве содержится важная информация, защищенная различными методами шифрования.',
    category: 'crypto',
    difficulty: 'advanced',
    points: 350,
    tags: ['cryptography', 'steganography', 'multi-layer'],
    solved: false,
    solvedBy: 28,
